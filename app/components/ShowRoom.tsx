  ...
  return (
    <div className="mx-auto xl:w-[556px] lg:w-[467px] w-[95%] border border-[#0000002D] mt-4 rounded-md py-1 shadow-xl">
      ...
      <div className="flex flex-col items-center">
        ...
        <h1 className="text-gray-600 font-semibold mt-2 text-[18px] text-center">
      ...
      >
        {showRoom.map((item: ShowRoomData) => (
          <div
            className={`flex flex-row items-center  lg:justify-betwee border-b border-b-[#0000002D] py-3 ${
              darkState ? 'bg-[#212529]' : 'bg-white'
            }`}
          >
            <div>
            ...
            <div className="flex flex-col ml-10">
              ...
              <div className="flex flex-row text-gray-600 lg:gap-6 gap-10 mt-6">
